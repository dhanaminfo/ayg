  ...
  return (
    <div style={{ backgroundColor: "#ebf0f7" }}>
      ...
      <Helmet>
        ...
        <meta
          name="keywords"
          content="39 HCB, HCB 39, 39 Speciale, American Yacht Group, center console yacht, luxury yacht, HCB comfort, spacious layout, convertible lounge, tackle station, panoramic view, cross-curved glass, smooth ride, luxurious yacht, family-friendly yacht, high-performance center console, premium yacht features, advanced helm, modern yacht design, versatile seating, luxury marine, top-rated center console, yacht with tackle station, elegant center console"
        />
        <meta name="robots" content="index, follow" />
        <meta
          property="og:title"
          content="39 Speciale | American Yacht Group"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.americanyachtgroup.com/39-speciale"
        />
