...
const NewsDetails = () => {
  return (
    <div>
      <Helmet>
        <title>Hurricane Prep for Your Yacht | American Yacht Group</title>
        <meta
          name="description"
          content="Protect your yacht during hurricane season with expert tips from American Yacht Group. Learn strategies for securing your vessel and ensuring safety"
        />
        <meta
          name="keywords"
          content="yacht hurricane preparation, yacht safety tips, hurricane season yacht, securing yacht hurricane, American Yacht Group, yacht protection, hurricane-proofing yachts, yacht storm readiness, marine safety, hurricane preparedness, yacht storm protection, yacht disaster planning, hurricane impact on yachts, yacht safety measures, yacht resilience, storm-secure yachts, emergency yacht procedures, yacht weather safety, hurricane-resistant yachts, yacht care during storms"
        />
        <meta name="robots" content="index, follow" />
        <meta
          property="og:title"
          content="Hurricane Prep for Your Yacht | American Yacht Group"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.americanyachtgroup.com/news-details/preparing-for-hurricane"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://ayg.s3.us-east-2.amazonaws.com/hurricane-season.jpeg"
        />
