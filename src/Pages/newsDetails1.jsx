...
const NewsDetails1 = () => {
  return (
    <div>
      <Helmet>
        <title>39’ Yacht Turns Heads | American Yacht Group</title>
        <meta
          name="description"
          content="Discover the stunning 39’ yacht making waves. American Yacht Group highlights its exceptional features and performance. Explore this remarkable vessel today!"
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="39’ Yacht Turns Heads | American Yacht Group"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.americanyachtgroup.com/news-details/39-turns-head"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://ayg.s3.us-east-2.amazonaws.com/hcb-fishing.jpg"
        />
